/**
   Raduino_v1.29 for BITX40 - Allard Munters PE1NWL (pe1nwl@gooddx.net)
...
void checkButton() {
  ...
  switch (action) {
    ...
    case 7: // toggle Roger Beep ON/OFF
      u.RogerBeep = !u.RogerBeep;
      if (u.RogerBeep)
        printLine(1, "Roger Beep ON");
      else
        printLine(1, "Roger Beep OFF");
      delay(1000);
      break;
...
void setup() {
  u.raduino_version = 29;
  strcpy (c, "Raduino v1.29");
